...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPasswordView = (EditText) findViewById(R.id.editTextPass);
        ...
        Button mEmailSignInButton = (Button) findViewById(R.id.btn_login_acc);
    ...
    private boolean mayRequestContacts() {
        ...
        if (shouldShowRequestPermissionRationale(READ_CONTACTS)) {
            Snackbar.make(mAccoutView, R.string.permission_rationale, Snackbar.LENGTH_INDEFINITE)
    ...
    private void attemptLogin() {
        ...
        // Reset errors.
        mAccoutView.setError(null);
        mPasswordView.setError(null);

        // Store values at the time of the login attempt.
        String email = mAccoutView.getText().toString();
        ...
        if (TextUtils.isEmpty(email)) {
            mAccoutView.setError(getString(R.string.error_field_required));
            focusView = mAccoutView;
            cancel = true;
        } else if (!isEmailValid(email)) {
            mAccoutView.setError(getString(R.string.error_invalid_email));
            focusView = mAccoutView;
            cancel = true;
        }
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        mAccoutView.setAdapter(adapter);
    }
